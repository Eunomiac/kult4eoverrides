...
const BUILDFILES = {
  js: {
    "./dist/kult4eoverrides/scripts/": ["mjs/**/*.mjs"]
  },
  css: {
    "./dist/kult4eoverrides/css/": ["scss/**/*.scss"],
    "./css/": ["scss/**/*.scss"]
  },
  html: {
    "./dist/kult4eoverrides/html": ["html/**/*.html"]
  },
  assets: {
    "./dist/kult4eoverrides/assets": ["assets/**/*.*"],
    "./dist/kult4eoverrides": ["module.json"]
  }
};
...
if (BUILDFUNCS_JS.length) {
  BUILDFUNCS.js = series(cleanDest("./dist/kult4eoverrides/mjs"), parallel(...BUILDFUNCS_JS));
...
if (BUILDFUNCS_CSS.length) {
  BUILDFUNCS.css = series(cleanDest("./dist/kult4eoverrides/css"), ...BUILDFUNCS_CSS);
...
if (BUILDFUNCS_HTML.length) {
  BUILDFUNCS.html = series(cleanDest("./dist/kult4eoverrides/html"), parallel(...BUILDFUNCS_HTML));
